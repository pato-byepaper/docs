...
<Steps titleSize="h3">
  <Step title="Paso 1 · Configuración General" icon="building-2" stepNumber={1}>
  ...
  <Step title="Paso 2 · Configurar Pisos" icon="layers" stepNumber={2}>
  ...
  <Step title="Paso 3 · Configurar Elementos" icon="package" stepNumber={3}>
  ...
  <Step title="Paso 5 · Configurar Áreas Comunes" icon="layout-grid" stepNumber={5}>
  ...
  <Step title="Paso 7 · Finalización y Verificación" icon="check-circle-2" stepNumber={7}>
